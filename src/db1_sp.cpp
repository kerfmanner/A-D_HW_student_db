...
void StudentDB_1Speed::load(const std::string &csv_path) {
...
std::vector<Student *> StudentDB_1Speed::find_by_birth(const int month, const int day) {
...
bool StudentDB_1Speed::change_group(const std::string &email, const std::string &new_group) {
...
std::string StudentDB_1Speed::find_group_with_max_same_birthday() {
    int best_count = -1;
